...
function NFTDropPage({ collection}: Props) {
 ...
 const mintNFT = () => {
   if (!nftDrop || !address) return;
    ...
    //how many unique NFTs u wanna claim
      ...
      <div className='flex flex-1 flex-col p-12 lg:col-span-6'>
         ...
         {/* Content */}
            ...
            <div className='flex items-center justify-center text-center '>
             <div className='flex mt-14 w-40  space-x-2  
             border-[#ec4079a6] border rounded-xl p-4  '>
              <p>NFT'S</p>
              <input 
              className='flex items-center justify-center bg-transparent text-right outline-none'
              type="number"
              min={1}
              max={3}
              value={quantity}
